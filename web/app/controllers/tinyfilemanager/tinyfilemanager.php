...
$CONFIG = '{"lang":"zh-CN","show_hidden":true,"hide_Cols":true,"calc_folder":false,"theme":"light","error_reporting":false}';
...
<head>
	...
	<?= HTML::css_link('/css/bootstrap.min.css?v=5.3.0-alpha1') ?>
	<?= HTML::css_link('/css/font-awesome.min.css?v=4') ?>
	<?= HTML::js_src('/js/jquery.min.js') ?>
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE && !FM_READONLY):
        ...
        ?>
    <?= HTML::js_src('/js/ace-editor/ace.js') ?>
    <script>
